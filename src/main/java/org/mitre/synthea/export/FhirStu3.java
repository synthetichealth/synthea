...
public class FhirStu3
{
	...
	private static BundleEntryComponent basicInfo(Person person, Bundle bundle, long stopTime)
	{
		...
		if (person.attributes.get(Person.IDENTIFIER_DRIVERS) != null) {
			Code code = new Code("http://hl7.org/fhir/v2/0203", "DL", "Driver's License");
			patientResource.addIdentifier()
				.setType(mapCodeToCodeableConcept(code, "http://hl7.org/fhir/v2/0203"))
		...
		if (person.attributes.get(Person.IDENTIFIER_PASSPORT) != null) {
			Code code = new Code("http://hl7.org/fhir/v2/0203", "PPN", "Passport Number");
			patientResource.addIdentifier()
				.setType(mapCodeToCodeableConcept(code, "http://hl7.org/fhir/v2/0203"))
		...
		//  identifiers (SSN, passport, fingerprint)
