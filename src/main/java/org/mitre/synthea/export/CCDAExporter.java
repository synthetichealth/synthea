...
public class CCDAExporter {
	...
	/**
	 * This is a dummy object for FreeMarker, because the library cannot access static class
	 * methods such as UUID.randomUUID()
	 */
	...
	private static Configuration templateConfiguration() {
		...
		configuration.setClassLoaderForTemplateLoading(ClassLoader.getSystemClassLoader(), "templates/ccda");
	 ...
	 *            Person to export.
	 * @param time
	 *            Time the record should be generated. Any content in the record
	 *            AFTER this time will not be included.
