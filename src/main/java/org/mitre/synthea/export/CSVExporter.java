...
public class CSVExporter {
   ...
   * @param subDirectoryName CSV sub-directory to use for files generated by this exporter (may be null)
   */
  public CSVExporter(String subDirectoryName) {
    try {
      String folderName = subDirectoryName == null ? "csv" : "csv" + File.separator + subDirectoryName;
      File output = Exporter.getOutputFolder(folderName, null);
      output.mkdirs();
