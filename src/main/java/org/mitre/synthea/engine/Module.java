...
public class Module {
	...
	/**
	 * @param path
	 *            : the relative path of the module, without the root or ".json"
	...
	public Module addRemark(String string) {
		getRemarks().add(string);
		return this;
	}
	...
	public State addState(State state, String stateName) {
		getStates().put(stateName, state);
		return state;
	}
