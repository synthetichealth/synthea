...
/**
 * Logic represents any portion of a generic module that requires a logical expression. This class
 * is stateless, and calling 'test' on an instance must not modify state as instances of Logic
 * within Modules are shared across the population.
 */
public class Logic {

  public enum ConditionType {
    GENDER("Gender"), SOCIOECONOMIC_STATUS("Socioeconomic Status"), RACE("Race"), AGE("Age"), DATE(
        "Date"), SYMPTOM("Symptom"), OBSERVATION("Observation"), VITAL_SIGN(
            "Vital Sign"), ACTIVE_CONDITION("Active Condition"), ACTIVE_MEDICATION(
                "Active Medication"), ACTIVE_CAREPLAN("Active CarePlan"), ATTRIBUTE(
                    "Attribute"), PRIOR_STATE("PriorState"), AND("And"), OR("Or"), NOT(
                        "Not"), AT_LEAST(
                            "At Least"), AT_MOST("At Most"), TRUE("True"), FALSE("False");
    ...
    case AGE:
      ...
      default:
        ...
        throw new UnsupportedOperationException(
            "Units '" + units + "' not currently supported in Age logic.");
      }
