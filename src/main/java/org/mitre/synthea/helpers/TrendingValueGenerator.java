 ...
 * It has the following properties: - values will start at a
 * time beginTime at a starting mean beginMean - values will end at a time
 * endTime at an ending mean endMean - values will be bounded by a minimum and
 * maximum value - values will be distributed with a given standard deviation
 */
