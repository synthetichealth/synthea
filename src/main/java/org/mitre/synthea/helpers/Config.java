...
public abstract class Config {
   ...
   * strings, including distinct keys in the default property list if a key of the
   * same name has not
   * already been found from the main properties list. Properties whose key or
   * value is not of type
   * String are omitted. The returned set is not backed by the Properties object.
   * Changes to this
