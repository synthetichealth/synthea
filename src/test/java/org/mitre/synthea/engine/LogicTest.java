...
public class LogicTest {
  ...
  public void test_symptoms() {
    person.setSymptom("Appendicitis", "PainLevel", System.currentTimeMillis(), 60, false);
    assertTrue(doTest("symptomPainLevelGt50"));
    assertTrue(doTest("symptomPainLevelLte80"));

    // painlevel still 60 here
    person.setSymptom("Appendicitis", "LackOfAppetite", System.currentTimeMillis(), 100, false);
    assertTrue(doTest("symptomPainLevelGt50"));
    assertTrue(doTest("symptomPainLevelLte80"));

    person.setSymptom("Appendicitis", "PainLevel", System.currentTimeMillis(), 10, false);
    assertFalse(doTest("symptomPainLevelGt50"));
    assertTrue(doTest("symptomPainLevelLte80"));

    person.setSymptom("Appicitis", "PainLevel", System.currentTimeMillis(), 100, false);
    assertTrue(doTest("symptomPainLevelGt50"));
