...
public class LogicTest {
  ...
  public void test_symptoms() {
    person.setSymptom(
        "Module1","PainLevel", System.currentTimeMillis(), 60, false
    );
    ...
    person.setSymptom(
        "Module2", "LackOfAppetite", System.currentTimeMillis(), 100, false
    );
    assertTrue(doTest("symptomPainLevelGt50"));
    assertTrue(doTest("symptomPainLevelLte80"));

    person.setSymptom(
        "Module1", "PainLevel", System.currentTimeMillis(), 10, false);
    assertFalse(doTest("symptomPainLevelGt50"));
    assertTrue(doTest("symptomPainLevelLte80"));

    person.setSymptom(
        "Module3", "PainLevel", System.currentTimeMillis(), 100, false);
    assertTrue(doTest("symptomPainLevelGt50"));
