...
public class ProviderTest {
  ...
  public static final RandomNumberGenerator random = new DefaultRandomNumberGenerator(1L);
  ...
  public void testLoadProvidersByAbbreviation() {
    Provider.loadProviders(location, random);
  ...
  @Test
  public void testNearestEmergencyInDC() throws Exception {
    ...
    Provider.loadProviders(capital, random);
    Person person = new Person(0L);
  ...
  public void testNearestInpatientInCity() {
    Provider.loadProviders(city, random);
    Person person = new Person(0L);
         ...
         .forEach(t -> {
           try {
             ...
             Provider.loadProviders(location, "providers/" + t.getFileName(),
                 ProviderType.HOSPITAL, providerServices, random, false);
           } catch (Exception e) {
