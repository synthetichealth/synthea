...
public class LostCareImpactsTest {
        ...
        public void setup() throws Exception {
                ...
                Module testLostCareModule = TestHelper.getFixture("lost_care_test.json");
        ...
        public void personDiesDueToLostCare() {
                ...
                // Set insurance, provider, encounter code.
                ...
                lostCareModule.process(person, time);
                assertFalse("Test that the person is no longer alive. The SNOMED code is now in the lost care record meaning they should die.",
                                person.alive(time));
