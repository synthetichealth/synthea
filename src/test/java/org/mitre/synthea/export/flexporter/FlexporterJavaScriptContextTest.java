...
public class FlexporterJavaScriptContextTest {
  ...
  public void testJavascriptContext() {
    ...
    outBundle.getEntry().forEach(entry -> {
      ...
      // check here is "contains" instead of simple equality because
      // HAPI seems to add the xmlns to the text, which is probably consistent, but this is the real point of the test
    });
  }
}
