...
**System Requirements:**
Synthea<sup>TM</sup> requires Java JDK 11 or newer. We strongly recommend using an LTS release (for example 11, 17, or 21) to minimize issues seen with short-lived releases; JDK 25 is supported.
