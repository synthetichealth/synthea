    ...
    module FhirRecord
      ...
      def self.condition(condition, fhir_record, patient, encounter, claim)
        ...
        fhir_condition = FHIR::Condition.new('id' => resource_id,
                                             ...
                                             'category' => {
                                               'coding' => [{ 'system' => 'http://argonaut.hl7.org', 'code' => 'problem' }]
                                             },
                                             'code' => {
                                               'coding' => [{
      ...
      def self.allergy(allergy, fhir_record, patient, _encounter, _claim)
        ...
        resource_id = SecureRandom.uuid
        allergy = FHIR::AllergyIntolerance.new('id' => resource_id,
                                               'assertedDate' => convert_fhir_date_time(allergy['time'], 'time'),
      ...
      def self.diagnostic_report(report, fhir_record, patient, encounter, _claim)
        ...
        entry.resource = FHIR::DiagnosticReport.new('id' => resource_id,
                                                    'status' => 'final',
                                                    'category' => {
                                                      'coding' => [{ 'system' => 'http://hl7.org/fhir/v2/0074', 'code' => 'LAB' }]
                                                    },
                                                    'code' => {
                                                    ...
                                                    'performer' => [{ 'actor' => { 'reference' => patient.resource.generalPractitioner[0].reference } }])
      ...
      def self.immunization(imm, fhir_record, patient, encounter, claim)
        resource_id = SecureRandom.uuid
        immunization = FHIR::Immunization.new('id' => resource_id,
                                              'status' => 'completed',
      ...
      def self.careplans(plan, fhir_record, patient, encounter, _claim)
        ...
        resource_id = SecureRandom.uuid
        careplan = FHIR::CarePlan.new('id' => resource_id,
                                      'subject' => { 'reference' => patient.fullUrl.to_s },
                                      'context' => { 'reference' => encounter.fullUrl.to_s },
