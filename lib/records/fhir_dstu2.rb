  ...
  module Output
    module FhirDstu2Record
      ...
      def self.allergy(allergy, fhir_record, patient, _encounter)
        ...
        allergy = FHIR::DSTU2::AllergyIntolerance.new('id' => resource_id,
                                                      'recordedDate' => convert_fhir_date_time(allergy['time'], 'time'),
      ...
      def self.quality_of_life_observation(observation, fhir_record, patient)
        Synthea::Output::FHIRVersionIndependent.quality_of_life_observation(observation, fhir_record, patient, FHIR::DSTU2)
      end
      ...
      def self.procedure(procedure, fhir_record, patient, encounter)
        ...
        resource_id = SecureRandom.uuid
        fhir_procedure = FHIR::DSTU2::Procedure.new('id' => resource_id,
                                                    'subject' => { 'reference' => patient.fullUrl.to_s },
                                                    'status' => 'completed',
                                                    'code' => {
      ...
      def self.immunization(imm, fhir_record, patient, encounter)
        resource_id = SecureRandom.uuid
        immunization = FHIR::DSTU2::Immunization.new('id' => resource_id,
                                                     'status' => 'completed',
      ...
      def self.careplans(plan, fhir_record, patient, encounter)
        ...
        resource_id = SecureRandom.uuid
        careplan = FHIR::DSTU2::CarePlan.new('id' => resource_id,
                                             'subject' => { 'reference' => patient.fullUrl.to_s },
      ...
      def self.care_goal(goal, goal_status, fhir_record)
        # TODO: search the patient for existing & active matching goals
        # instead of always creating new ones?
        resource_id = SecureRandom.uuid
        fhir_goal = FHIR::DSTU2::Goal.new('id' => resource_id, 'status' => goal_status)
      ...
      def self.medications(prescription, fhir_record, patient, encounter)
        ...
        resource_id = SecureRandom.uuid
        med_order = FHIR::DSTU2::MedicationOrder.new('id' => resource_id,
